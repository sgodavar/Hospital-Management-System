<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ITCentral.aspx.cs" Inherits="WebApplication1.ITCentral" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>IT Central</title>
...
<body>
    ...
    <div class="auto-style18">
            <div class="auto-style18">
            <img alt="" class="auto-style12" src="images/HPic.png" /><span class="auto-style17"><strong>IT Central</strong></span></strong><strong><img alt="" class="auto-style13" src="images/HPic.png" /><div class="auto-style18">
                </div>
                </strong>
            </div>
            ...
            <tr>
                <td class="auto-style19" style="border-style: none" colspan="3">
                    <asp:HyperLink ID="HyperLink7" runat="server" NavigateUrl="~/UpdatePatient.aspx">Update Patient Information</asp:HyperLink>
                </td>
            </tr>
            <tr>
                <td class="auto-style19" style="border-style: none" colspan="3">
                    <asp:HyperLink ID="HyperLink5" runat="server" NavigateUrl="~/AddEmployee.aspx">Add Employee</asp:HyperLink>
                </td>
            </tr>
            <tr>
                 <td class="auto-style19" style="border-style: none" colspan="3">
                    <asp:HyperLink ID="HyperLink6" runat="server" NavigateUrl="~/Association.aspx">Personnel Associations</asp:HyperLink>
                </td>
            </tr>
            <tr>
                <td class="auto-style19" style="border-style: none" colspan="3">
