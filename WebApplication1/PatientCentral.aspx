<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PatientCentral.aspx.cs" Inherits="WebApplication1.PatientCentral" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Patient Central</title>
    <style type="text/css">
        .auto-style2 {
            width: 100%;
        }
...
<body>
    ...
    <div class="auto-style18">
            <div class="auto-style18">
            <img alt="" class="auto-style12" src="images/HPic.png" /><span class="auto-style17"><strong>Patient Central</strong></span></strong><strong><img alt="" class="auto-style13" src="images/HPic.png" /><div class="auto-style18">
                </div>
                </strong>
            </div>
