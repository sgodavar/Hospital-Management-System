<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdatePatient.aspx.cs" Inherits="WebApplication1.UpdatePatient" %>
...
<body>
    ...
    <style>
        ...
        <div class="auto-style18">
            <img alt="" class="auto-style12" src="images/HPic.png" /><span class="auto-style17"><strong>Update Patient Information</strong></span></strong><strong><img alt="" class="auto-style13" src="images/HPic.png" /><div class="auto-style18">
                </div>
                </strong>
            </div>
            ...
            <tr>
                ...
                <td class="auto-style27" style="border-style: none">
                    <asp:DropDownList ID="DropDownList1" runat="server" CssClass="auto-style37" Height="17px" Width="532px">
                    </asp:DropDownList>
                </td>
                <td class="auto-style9" style="border-style: none">
                    &nbsp;</td>
            ...
            <tr>
                <td class="auto-style30" style="border-style: none; font-weight: 700;">
                    Emergence Contact Telephone Number</td>
                <td class="auto-style31" style="border-style: none">
            ...
            <tr>
                ...
                <td class="auto-style36" style="border-style: none">
                    </td>
            </tr>
            <tr>
                <td class="auto-style28" style="border-style: none">
