<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DoctorCentral.aspx.cs" Inherits="WebApplication1.DoctorCentral" %>
...
<body>
    ...
    <div class="auto-style18">
            <div class="auto-style18">
            <img alt="" class="auto-style12" src="images/HPic.png" /><span class="auto-style17"><strong>Doctor Central</strong></span></strong><strong><img alt="" class="auto-style13" src="images/HPic.png" /><div class="auto-style18">
                </div>
                </strong>
            </div>
         <table class="auto-style2" border="0">
            ...
            <tr>
                <td class="auto-style14" style="border-style: none" colspan="3">
                    <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/OpenAppointment.aspx">Open Appointment</asp:HyperLink>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="auto-style19" style="border-style: none" colspan="3">
                    <asp:Button ID="Button1" runat="server" Text="Logout" Width="203px" OnClick="Button1_Click" />
                </td>
            </tr>
        </table>
